...
export default function ImportExportPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      {/* Export */}
      <section className="mb-5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <a
            ...
            className="rounded-lg border border-zinc-300 dark:border-zinc-700 px-4 py-2 text-sm font-medium hover:bg-zinc-50 dark:hover:bg-zinc-800"
          >
            ⬇ Export vCard
          </a>
        </div>
      ...
      <section className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5">
        ...
        <input
          ...
          className="block w-full text-sm text-zinc-600 file:mr-3 file:rounded-lg file:border-0 file:bg-indigo-600 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white hover:file:bg-indigo-700 dark:text-zinc-300"
        />

        {parsed && (
          <div className="mt-4 rounded-lg border border-indigo-200 dark:border-indigo-900/50 bg-indigo-50/40 dark:bg-indigo-950/20 p-3">
            <p className="text-sm">
            ...
            <div className="mt-3 flex gap-2">
              ...
              <button
                ...
                className="rounded-lg border border-zinc-300 dark:border-zinc-700 px-4 py-2 text-sm font-medium"
              >
                Cancel
              </button>
            </div>
        ...
        {summary && (
          <div className="mt-4 rounded-lg bg-emerald-50 dark:bg-emerald-950/30 p-3 text-sm text-emerald-700 dark:text-emerald-300">
